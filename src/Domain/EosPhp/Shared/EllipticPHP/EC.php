...
use Domain\EosPhp\Shared\EllipticPHP\EC\KeyPair;
use Domain\EosPhp\Shared\EllipticPHP\EC\Signature;
...
class EC
{
    ...
    public function genKeyPair($options = null)
    {
        ...
        $drbg = new HmacDRBG([
            'hash' => $this->hash,
            'pers' => $options['pers'] ?? '',
            'entropy' => $options['entropy'] ?? Utils::randBytes($this->hash['hmacStrength']),
