...
use Domain\EosPhp\Shared\EllipticPHP\Curve\ShortCurve\Point;
use Domain\EosPhp\Shared\EllipticPHP\Curve\ShortCurve\JPoint;
...
class ShortCurve extends BaseCurve
{
    ...
    public function __construct($conf)
    {
        ...
        $this->_endoWnafT1 = [0,0,0,0];
        $this->_endoWnafT2 = [0,0,0,0];
    }
