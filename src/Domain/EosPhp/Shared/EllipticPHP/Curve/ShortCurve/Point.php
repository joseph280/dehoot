...
namespace Domain\EosPhp\Shared\EllipticPHP\Curve\ShortCurve;

use JsonSerializable;
use Domain\EosPhp\Shared\BN\BN;
use Domain\EosPhp\Shared\EllipticPHP\Curve\BaseCurve\Point as BaseCurvePoint;

class Point extends BaseCurvePoint implements JsonSerializable
{
    public $x;
    ...
    public function __construct($curve, $x, $y, $isRed)
    {
